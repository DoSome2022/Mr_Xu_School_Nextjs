...
const EditPublicHolidaysPagebysupadmin = () => {
  ...
  return (
    <div>
      ...
      <Public_Holidays_Edit_Formbysupadmin PublicHolidays={GetPublicHolidaysById} />
    </div>
  );
};

export default EditPublicHolidaysPagebysupadmin;