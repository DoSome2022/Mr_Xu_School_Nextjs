...
console.log(data)
    ...
    return(
        <>
            ...
            <br />
                <Link className="text-stone-950 hover:text-gray-700" 
                    href={`/supadmin/${supadminid}/schoolLists/${SchoolId}/expageLists/${grades.school_grade}`}
                >
    ...
    <div className="min-h-screen bg-gray-100 pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-[#80A8BD]">考試卷 - 年級列表</h1>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          <h2 className="text-xl font-semibold text-gray-700 mb-4">年級列表</h2>
          {data.length === 0 ? (
            ...
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
              {data.map((grade) => (
                <Link
                  ...
                  href={`/supadmin/${supadminid}/schoolLists/${SchoolId}/expageLists/${grade.school_grade}`}
...
export default ExPageListsbysupadmin