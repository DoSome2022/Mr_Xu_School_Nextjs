...
const SchoolTimeTableLists_Gradebysupadmin = () => {
  ...
  const SchoolName = getschooldata && getschooldata[0] ? getschooldata[0].school_name : "未知學校";
    ...
    return(
        <>
            {/* <span> SchoolTimeTableLists_Gradebysupadmin </span>

            <br />
                    <Link className="text-stone-950 hover:text-gray-700"  
                        href={`/supadmin/${supadminid}/schoolLists/${SchoolId}/schooltimetableLists/upload`}
                    >
                        上傳學校時間表
                    </Link>
                    <br />
            ...
            <br />
                <Link className="text-stone-950 hover:text-gray-700" 
                    href={`/supadmin/${supadminid}/schoolLists/${SchoolId}/schooltimetableLists/${grades.school_grade}`}
                >
     ...
     <div className="min-h-screen bg-gray-100 pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h1 className="text-2xl font-bold text-gray-800 mb-6">學校時間表</h1>
