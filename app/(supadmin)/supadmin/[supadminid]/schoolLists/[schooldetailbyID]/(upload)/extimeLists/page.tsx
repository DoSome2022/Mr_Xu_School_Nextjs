...
import { useEffect, useState } from "react";
    ...
    const fetcher = (url: string, init?: RequestInit):Promise<StudentSchoolGrade[]>  => fetch(url, {
...
const ExTimeListsbysupadminbysupadmin = () => {
        ...
        <>
            ...
            <br />
                    <Link className="text-stone-950 hover:text-gray-700"  
                        href={`/supadmin/${supadminid}/schoolLists/${SchoolId}/extimeLists/upload`}
                    >
                        上傳考試時間表
                    </Link>
                    <br />
            ...
            <br />
                <Link className="text-stone-950 hover:text-gray-700" 
                    href={`/supadmin/${supadminid}/schoolLists/${SchoolId}/extimeLists/${grades.school_grade}`}
                >
    ...
    <div className="min-h-screen bg-gray-100 pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h1 className="text-2xl font-bold text-gray-800 mb-6">考試時間表</h1>
...
export default ExTimeListsbysupadminbysupadmin