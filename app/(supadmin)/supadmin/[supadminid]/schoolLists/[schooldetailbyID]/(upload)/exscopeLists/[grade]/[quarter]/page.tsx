...
const ExScopeLists_Grade_Quarter_subjectbysupadmin = () =>{
    ...
    const params = useParams<{grade : string ; quarter: string; schooldetailbyID:string; supadminid:string}>();
...
<div className="min-h-screen bg-gray-100 pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h1 className="text-2xl font-bold text-gray-800 mb-6">考試範圍 - 科目</h1>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {data.map((subject) => (
              <Link
                key={subject.school_subject}
                href={`/supadmin/${supadminid}/schoolLists/${SchoolId}/exscopeLists/${GradeId}/${QuarterId}/${subject.school_subject}`}
...
export default ExScopeLists_Grade_Quarter_subjectbysupadmin