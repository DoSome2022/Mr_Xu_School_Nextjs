...
import Class_Updata_Custom_Form_v1bysupadmin from "@/components/CreateForm/SUPADMIN/UpdateForm/Sup-Class-Update-Form";
import Link from "next/link";
import { useParams } from "next/navigation";

const ClassDetailEditbysupadmin = () => {
    ...
    <div className="min-h-screen bg-gray-100 pt-20"> {/* 留出空間給固定導航欄 */}
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-[#e7915b]">編輯課堂詳情</h1>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          <Class_Updata_Custom_Form_v1bysupadmin />
        </div>
      </div>
    </div>
  );
...
export default ClassDetailEditbysupadmin;