  ...
  return (
    <div className="min-h-screen bg-gray-100 pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-[#e7915b] mb-6">
          ...
          {GetCourseDataById.class && GetCourseDataById.class.length > 0 ? (
            <div className="grid gap-4">
              {GetCourseDataById.class.map((d: Class) => (
                <Link
                  key={d.id}
                  href={`/supadmin/${SupadminId}/courseLists/${CourseId}/classLists/${d.id}`}
...
export default ClassListsbysupadmin;