...
import ChangeClass_Create_Formbysupadmin from "@/components/CreateForm/SUPADMIN/Sup-ChangeClass-Create-Form";
import Link from "next/link";
import { useParams } from "next/navigation";

const ChangeClassStudentbysupadmin = () => {
    ...
    <div className="min-h-screen bg-gray-100 pt-20"> {/* 留出空間給固定導航欄 */}
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          <ChangeClass_Create_Formbysupadmin />
        </div>
      </div>
    </div>
  );
...
export default ChangeClassStudentbysupadmin;