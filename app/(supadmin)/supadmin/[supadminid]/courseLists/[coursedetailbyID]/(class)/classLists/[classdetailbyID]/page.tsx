        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          <div className="grid gap-4">
            ...
            <div className="flex space-x-4">
              <Link
                href={`/supadmin/${supadminId}/courseLists/${CourseId}/classLists/${ClassId}/leavestudent`}
                className="inline-block text-white bg-[#e7915b] px-4 py-2 rounded-md hover:bg-cyan-200 hover:text-gray-800 transition-colors duration-300"
              >
                請假學生
              </Link>
              <Link
                href={`/supadmin/${supadminId}/courseLists/${CourseId}/classLists/${ClassId}/addclassstudent`}
                className="inline-block text-white bg-[#e7915b] px-4 py-2 rounded-md hover:bg-cyan-200 hover:text-gray-800 transition-colors duration-300"
              >
                加入加堂學生
              </Link>
...
export default ClassDetailbysupadmin;