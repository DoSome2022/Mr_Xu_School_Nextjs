...
import LeaveStudentFormbysupadmin from "@/components/CreateForm/SUPADMIN/Sup-LeaveStudent-Form";
import Link from "next/link";
import { useParams } from "next/navigation";

const LeaveStudentPagebysupadmin = () => {
    ...
    <div className="min-h-screen bg-gray-100 pt-20"> {/* 留出空間給固定導航欄 */}
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-[#e7915b]">學生請假</h1>
...
export default LeaveStudentPagebysupadmin;