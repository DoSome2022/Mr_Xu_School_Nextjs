...
import ClassDetailListsbysupadmin from "@/components/DatasLIsts/SupClassDetailLists";
    ...
    <div className="min-h-screen bg-gray-100 pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mt-6">
          ...
          <ClassDetailListsbysupadmin data={GetCourseDataById} SupAdminId={SupAdminId} />
        </div>
      </div>
    </div>
  );
...
export default CourseDetailbysupadmin;