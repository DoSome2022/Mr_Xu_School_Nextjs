...
const ExPageLists_Grade_Year_Quarterbysupadmin = () => {
    ...
    const params = useParams<{supadminId: string;parentdetailbyID : string ; studentdetailbyID : string ; school : string; grade : string ; year: string;}>();
    ...
    const fetcher = (url: string, init?: RequestInit):Promise<Student_School_quarter[]>  => fetch(url, init).then((res) => res.json());
