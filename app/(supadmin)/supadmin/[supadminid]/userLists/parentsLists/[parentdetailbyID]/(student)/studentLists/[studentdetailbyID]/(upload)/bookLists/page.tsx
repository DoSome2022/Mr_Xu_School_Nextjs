...
// 定義 SchoolData 介面，根據 Prisma 模型中的 Student 結構
...
const Student_BookLists_Schoolbysupadmin = () => {
  ...
  // 篩選與 studentdetailbyID 相符的學生資料
  const filteredStudentData = GetSutudentData.filter((data) => data.id === StudentID);
    ...
    <div className="container mx-auto px-4 py-6 bg-blue-50 min-h-screen">
      ...
      <div className="p-5 max-w-4xl mx-auto">
        ...
        {filteredStudentData.length > 0 ? (
          ...
          <p className="text-gray-500">無符合條件的學校資料</p>
        )}
      </div>
    </div>
  );
