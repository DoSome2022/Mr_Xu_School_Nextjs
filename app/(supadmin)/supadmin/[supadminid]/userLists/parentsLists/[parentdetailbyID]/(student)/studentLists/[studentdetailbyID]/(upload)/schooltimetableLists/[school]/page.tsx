...
// const SchoolTimeTableLists_Gradebysupadmin = () => {
...
//             href={`/supadmin/${supadminId}/userLists/parentsLists/${ParentID}/studentLists/${StudentID}/schooltimetableLists/${SchoolName}/${grades.school_grade}`}
//         >
...
// export default SchoolTimeTableLists_Gradebysupadmin
...
const SchoolTimeTableLists_Gradebysupadmin = () => {
  ...
  if (
    !data ||
    !Array.isArray(data) ||
    !data.every((item) => typeof item.id === "number" && typeof item.school_grade === "number" && gradeMapping[item.school_grade])
  ) {
    return (
      <div className="bg-red-50 text-red-600 p-4 rounded-lg">
        無效的年級資料格式
      ...
      <div className="flex flex-col space-y-4">
        {data.map((grades) => (
          <Link
            ...
            href={`/supadmin/${supadminId}/userLists/parentsLists/${ParentID}/studentLists/${StudentID}/schooltimetableLists/${encodeURIComponent(SchoolName)}/${encodeURIComponent(grades.school_grade)}`}
          >
