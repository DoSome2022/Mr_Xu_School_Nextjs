...
// import Student_EX_Time_Create_Formbysupadmin from "@/components/CreateForm/SUPADMIN/UploadForm/student/Sup-Student-EX-Time-Create-Form";
...
//     school: string;
// }
// const Student_ExTimeLists_uploadbysupadmin = () =>{
...
//     return(
//         <>
//         <Student_EX_Time_Create_Formbysupadmin studentId={StudentID} data={GetStudentData}  />
//         </>
//     )
    
// }

// export default Student_ExTimeLists_uploadbysupadmin
  ...
  return (
    <div className="container mx-auto px-4 py-6 bg-blue-50 min-h-screen">
      ...
      <h2 className="text-2xl font-semibold text-blue-600 mb-4">
        為學生 {data[0]?.name || StudentID} 上傳考試時間表
      </h2>

      <Student_EX_Time_Create_Formbysupadmin studentId={StudentID} data={data} />
    </div>
  );
};
