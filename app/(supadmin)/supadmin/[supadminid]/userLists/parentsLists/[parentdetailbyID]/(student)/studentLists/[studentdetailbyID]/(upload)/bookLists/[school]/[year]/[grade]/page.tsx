...
const Student_BookLists_School_Year_Grade_Listsbysupadmin= () => {
    const params = useParams<{parentdetailbyID : string ; studentdetailbyID : string ; school : string ; year : string ; grade : string; supadminId:string ;}>();
    console.log(params)
    ...
    return(
        <>
            <span> Student_BookLists_School_Year_Grade_Listsbysupadmin </span>
