...
const parentsListsbysupadmin:React.FC = () =>{
    ...
    return(
        ...
        <br />
            parentsListsbysupadmin
        <br />
        <Link
        className="text-stone-950 hover:text-gray-700" 
        href={`/supadmin/${supadminId}/userLists/parentsLists/createParent`} > 建立家長 </Link>
...
<br />
    {
        ...
        GetParentsData.map((data)=>{
            ...
            return(
                <>
                <Link className="text-stone-950 hover:text-gray-700" href={`/supadmin/${supadminId}/userLists/parentsLists/${data.id}`}>
