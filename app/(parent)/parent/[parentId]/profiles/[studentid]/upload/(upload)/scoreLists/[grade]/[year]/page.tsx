...
const ScoreLists_Year_Quarter = () => {
    ...
    const params = useParams<{parentId : string ; studentid : string ;  grade : string ; year: string;}>();
    ...
    return(
        <>
            ...
            {data.map((quarters:any)=>{
                return(
                    <div key={quarters.school_quarter}>
            <br />
                <Link className="text-stone-950 hover:text-gray-700" 
                    href={`/parent/${ParentID}/profiles/${StudentID}/upload/scoreLists/${Grade}/${Year}/${quarters.school_quarter}`}
                >
