...
const ExPageLists_Grade_Year_Quarter_Subject = () => {
    ...
    return(
        <>
            <span> ExPageLists_Grade_Year_Quarter_Subject 家長 </span>
            ...
            <br />
                <Link className="text-stone-950 hover:text-gray-700" 
                    href={`/parent/${ParentID}/profiles/${StudentID}/upload/expageLists/${SchoolName}/${Grade}/${Year}/${Quarter}/${subject.school_subject}`}
                >
