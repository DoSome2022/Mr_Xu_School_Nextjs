...
import Parent_Student_ExscopeLists_Create_Form from "@/components/CreateForm/Parent-Student/Parent-Student_ExscopeLists_Create_Form";
...
const Student_ExscopeLists_upload = () =>{
    ...
    return(
        <>
<Parent_Student_ExscopeLists_Create_Form />
        </>
    )
