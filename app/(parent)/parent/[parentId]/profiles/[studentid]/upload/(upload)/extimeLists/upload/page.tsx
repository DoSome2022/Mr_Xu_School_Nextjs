...
import Parent_Student_ExtimeLists_Create_Form from "@/components/CreateForm/Parent-Student/Parent-Student_ExtimeLists_Create_Form";
...
const Student_ExTimeLists_upload = () =>{
    ...
    return(
        <>
<Parent_Student_ExtimeLists_Create_Form  />
        </>
    )
