...
const Student_BookLists_School_Year_Grade = () => {
    const params = useParams<{parentId : string ; studentid : string ; school : string ; year : string}>();
    ...
    return(
        <>
            Student_BookLists_School_Year_Grade
            ...
            return(
                ...
                <br />
                    <Link
                        ...
                        href={`/parent/${ParentID}/profiles/${StudentID}/upload/bookLists/${SchoolName}/${Year}/${grades.school_grade}`}
                    >
