...
const ShopPage = () => {
  ...
  const userId = params.parentId as string;
  ...
  return (
    <div className="bg-[#80A8BD] min-h-screen text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-gray-900 border bg-gray-900 text-white placeholder-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600"
              />
            </div>
            {/* <div>
