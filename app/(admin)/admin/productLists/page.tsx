    ...
    <div className="min-h-screen bg-gray-100 pt-20">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-[#80A8BD]">商品列表</h1>
          <Link
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="flex-1 border-gray-300 rounded-md p-2 focus:border-[#80A8BD] focus:ring-[#80A8BD] transition-colors duration-300"
              />
              <select
                value={searchField}
          ...
          {GetProductData.length > 0 ? (
            <div className="space-y-4">
              {GetProductData.map((data) => (
                <Link
                  key={data.id}
                  href={`/admin/productLists/${data.id}`}
                  className="block p-4 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors duration-300"
                >
