      ...
      <div className="pt-16 min-h-screen bg-gray-50 p-4">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
            <span className="text-[#e7915b] animate-pulse">載入發票數據中...</span>
          </div>
        </div>
      </div>
    );
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white shadow-md rounded-lg overflow-hidden">
          <div className="p-6">
            <h1 className="text-2xl font-bold text-[#e7915b] mb-6">發票詳情</h1>
            ...
            {GetInvoiceByIdData.map((d) => (
              <div key={d.id} className="space-y-6">
                          ...
                          <Button 
                            ...
                            className={`w-full md:w-auto ${
                              d.isPayment 
                                ...
                                : "bg-[#e7915b] hover:bg-[#d9824c] text-white"
                            }`}
                          >
                ...
                <div className="bg-gray-50 p-4 rounded-lg border border-[#e7915b]">
                  <h3 className="text-lg font-semibold text-[#e7915b] mb-3">內容詳情</h3>
                  <div className="space-y-2">
                    {d.content.length > 0 ? (
