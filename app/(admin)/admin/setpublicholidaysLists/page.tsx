  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 mt-16">
      <Link
        ...
        className="inline-block bg-[#80A8BD] text-white px-4 py-2 rounded-md font-medium text-sm hover:bg-cyan-200 hover:text-[#80A8BD] transition-colors duration-300"
      >
        創建公眾假期
      </Link>
      <div className="mt-6 space-y-4">
        {GetPublicHolidaysLists.map((phl) => (
          <div
            key={phl.id}
            className="bg-white shadow-lg rounded-md p-4 hover:bg-[#80A8BD] hover:bg-opacity-10 transition-colors duration-300"
          >
            <Link
