...
const schoolLists = () => {
    ...
    return(
        <>
            <span>
                <Link className="text-stone-950 hover:text-gray-700" href={"/admin/schoolLists/createSchool"}>
                    建立學校
                </Link>
                <br />
        ...
        <br />
                ...
                <div className="bg-slate-100" key={data.id}>
                            ...
                            <Link className="text-stone-950 hover:text-gray-700" href={`/admin/schoolLists/${data.id}`}>
                                <br />
                                學校: {data.school_name}
                            </Link>
                </div>
