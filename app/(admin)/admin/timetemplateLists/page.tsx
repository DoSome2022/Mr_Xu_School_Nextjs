            ...
            <div className="pt-16 min-h-screen bg-gray-50 p-4">
                <div className="max-w-7xl mx-auto">
                    <div className="bg-white p-6 rounded-lg shadow-md text-center">
                        <span className="text-[#80A8BD] animate-pulse">載入時間模板中...</span>
                    </div>
                </div>
            </div>
        );
                ...
                <div className="bg-white shadow-md rounded-lg overflow-hidden">
                    <div className="p-6">
                        <div className="flex justify-between items-center mb-6">
                            <h1 className="text-2xl font-bold text-[#80A8BD]">時間模板列表</h1>
                            <Link 
                                href="/admin/timetemplateLists/createtimetemp"
                                className="bg-[#80A8BD] hover:bg-[#d9824c] text-white px-4 py-2 rounded-md transition-colors duration-300"
                            >
                                創建新模板
                            </Link>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {GetTimeTempList.map((d) => (
                                    <Link
                                        ...
                                        className="block p-6 border-2 border-[#80A8BD] rounded-lg hover:bg-[#80A8BD] hover:text-white transition-colors duration-300"
                                    >
