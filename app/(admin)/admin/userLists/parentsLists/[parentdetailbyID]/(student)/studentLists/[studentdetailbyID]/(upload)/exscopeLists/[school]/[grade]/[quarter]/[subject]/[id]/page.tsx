    ...
    if (StudentID && Id) {
      const getstudentexscopedetailbyid = async (StudentID: string, id: string) => {
        try {
          ...
          setGetStudentExScopeDetailByID(transformedResult);
        } catch (error) {
          console.error(error);
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gray-100 pt-20 flex justify-center items-center">
        ...
        <p className="ml-4 text-gray-600 text-lg">正在加載...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      <nav className="mb-4 text-sm max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <span className="mx-2">/</span>
        <Link
          href={`/admin/userLists/parentsLists/${ParentID}/studentLists/${StudentID}/exscopeLists/${encodeURIComponent(SchoolName)}`}
          className="text-blue-600 hover:text-blue-800"
        >
          {SchoolName}
        </Link>
        <span className="mx-2">/</span>
        <Link
          href={`/admin/userLists/parentsLists/${ParentID}/studentLists/${StudentID}/exscopeLists/${encodeURIComponent(SchoolName)}/${encodeURIComponent(Grade)}`}
          className="text-blue-600 hover:text-blue-800"
        >
        ...
        <span className="mx-2">/</span>
        <Link
          href={`/admin/userLists/parentsLists/${ParentID}/studentLists/${StudentID}/exscopeLists/${encodeURIComponent(SchoolName)}/${encodeURIComponent(Grade)}/${encodeURIComponent(Quarter)}`}
          className="text-blue-600 hover:text-blue-800"
        >
          第{Quarter}季度
        </Link>
        <span className="mx-2">/</span>
        <Link
          href={`/admin/userLists/parentsLists/${ParentID}/studentLists/${StudentID}/exscopeLists/${encodeURIComponent(SchoolName)}/${encodeURIComponent(Grade)}/${encodeURIComponent(Quarter)}/${encodeURIComponent(Subject)}`}
          className="text-blue-600 hover:text-blue-800"
        >
          {Subject}
        </Link>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="bg-[#80A8BD] px-6 py-4">
            <h1 className="text-xl font-bold text-white">
              {SchoolName} - {gradeMapping[Grade] || Grade} - 第{Quarter}季 - {Subject} - 學習範圍詳情
            </h1>
          </div>
                  ...
                  <div key={d.id} className="space-y-4">
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                      <div className="bg-gray-100 p-3 border-b border-gray-200">
                        <h3 className="font-medium text-gray-700">學習範圍文件</h3>
                      </div>
