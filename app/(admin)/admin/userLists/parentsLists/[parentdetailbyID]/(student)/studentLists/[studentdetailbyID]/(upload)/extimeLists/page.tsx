...
//                     href={`/admin/userLists/parentsLists/${ParentId}/studentLists/${StudentID}/extimeLists/upload`}
//                 >
//                     上傳考試時間表
//                     </Link>
//                     <br />
...
//                     <Link
//                     className="text-stone-950 hover:text-gray-700"
//                     href={`/admin/userLists/parentsLists/${ParentId}/studentLists/${StudentID}/extimeLists/${d.school}`}
//                 >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div className="bg-[#e7915b] px-6 py-4">
                        <h1 className="text-xl font-bold text-white">考試時間表管理</h1>
                    </div>
                    ...
                    <div className="p-6">
                        {isLoading ? (
                            <div className="text-center py-12">
                                <div className="inline-block animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 border-[#e7915b]"></div>
                                            ...
                                            {GetStudentData.map((d) => (
                                                ...
                                                >
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="text-gray-800 group-hover:text-[#e7915b] transition-colors duration-300">{d.school}</span>
                                                    </div>
                                                </Link>
                                            ))}
                                        </div>
