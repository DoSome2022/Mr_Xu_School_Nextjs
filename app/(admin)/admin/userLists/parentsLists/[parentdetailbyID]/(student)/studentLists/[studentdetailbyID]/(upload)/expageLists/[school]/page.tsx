...
const ExPageLists_Grade = () => {
  ...
  return (
    <div className="p-5 max-w-4xl mx-auto">
      ...
      <h2 className="text-2xl font-bold text-[#80A8BD] mb-6">考試卷年級列表</h2>
      {data.length > 0 ? (
        <div className="space-y-4">
          {data.map((grades) => (
            ...
            >
              <Link
                href={`/admin/userLists/parentsLists/${ParentID}/studentLists/${StudentID}/expageLists/${SchoolName}/${grades.school_grade}`}
