    ...
    if (StudentID && Id) {
      const getstudentextimedetailbyid = async (StudentID: string, id: string) => {
        try {
          ...
          setGetStudentExTimeDetailByID(transformedResult);
        } catch (error) {
          console.error(error);
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="bg-[#80A8BD] px-6 py-4">
            <h1 className="text-xl font-bold text-white">
              {SchoolName} - {gradeMapping[Grade] || Grade} - {Year}年 - 第{Quarter}季 - {Subject} - 考試時間表詳情
            </h1>
          </div>
                  ...
                  <div key={d.id} className="space-y-4">
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                      <div className="bg-gray-100 p-3 border-b border-gray-200">
                        <h3 className="font-medium text-gray-700">考試時間表文件</h3>
                      </div>
