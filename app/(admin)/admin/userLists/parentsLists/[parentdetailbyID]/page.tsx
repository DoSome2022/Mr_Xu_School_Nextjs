      ...
      <div className="bg-[#80A8BD] shadow-lg rounded-lg p-8 max-w-4xl w-full">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
          <Link
            ...
            className="inline-block px-4 py-2 bg-white text-[#80A8BD] font-medium rounded-md hover:bg-cyan-200 hover:text-[#80A8BD] transition-colors duration-300 text-center"
          >
            建立學生
          </Link>
          <Link
