      ...
      <div className="w-full max-w-7xl bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <Link
            ...
            className="inline-block px-4 py-2 bg-[#e7915b] text-white rounded-md hover:bg-cyan-200 hover:text-gray-800 transition-colors duration-300 text-sm font-medium"
          >
            更改
          </Link>
        </div>
