...
const newsLists = () =>{
    ...
    return(
        <>          
        <Link className="text-stone-950 hover:text-gray-700" href={"/admin/newsLists/createNews"}>
            建立公告
        </Link>
            <span>newsLists</span>
        ...
        <div className="flex items-center space-x-2">
                      ...
                      return(
                        ...
                        <div key={N.id} >
                        <Link href={`/admin/newsLists/${N.id}`}>
                        模組 : {N.title}, 
                        內容 : {N.content}, 
                        日期 : {N.date}, 
...

            {
                GetNewsData.map((data) => {
                    return(
                        ...
                        <>
                            <Link className="text-stone-950 hover:text-gray-700" href={`/admin/newsLists/${data.id}`}>
                                <br />
                                標題: {data.title}
                                <br />
                                內容: {data.content}
