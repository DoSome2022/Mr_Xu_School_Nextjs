    ...
    <div className="min-h-screen bg-gray-100 pt-20">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-[#e7915b]">公告列表</h1>
          <Link
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center space-x-2">
              <Input
                ...
                className="flex-1 border-gray-300 focus:border-[#e7915b] focus:ring-[#e7915b] transition-colors duration-300"
              />
              <select
                value={searchField}
