    ...
    <div className="min-h-screen bg-gray-100 pt-20">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-[#e7915b]">課程列表</h1>
          <Link
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-4 sm:space-y-0">
            ...
            <select
              ...
              className="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#e7915b] transition-colors duration-300"
            >
              ...
              {searchResults.map((course) => (
                ...
                >
                  <div className="p-4 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors duration-300">
                    <h3 className="text-lg font-semibold text-[#e7915b]">{course.course_name}</h3>
