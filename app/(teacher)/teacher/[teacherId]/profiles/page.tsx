...
const Profiles = () => {
    ...
    return (
      <div className="container mx-auto p-4">
        <div className="animate-pulse">
          <div className="h-6 bg-[#80A8BD] rounded w-1/2 mb-4"></div>
          <div className="h-32 bg-[#80A8BD] rounded"></div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto h-full w-full bg-[#80A8BD]0 p-4">
      <div className="grid grid-cols-1 sm:grid-cols-6 gap-4">
        <div className="col-span-6 flex justify-between">
          <p className="bg-[#80A8BD] text-lg">個人信息</p>
          <div className="flex space-x-2">
            <Logout_Button />
          </div>
        </div>
        ...
        <div className="col-span-5 mt-8">
          <div className="bg-[#80A8BD] p-6 rounded-lg shadow-lg">
