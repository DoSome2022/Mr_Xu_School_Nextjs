    ...
    if (GetClassData) {
      ...
      if (classData.class_date) {
        ...
        if (!isNaN(date.getTime())) {
          class_updata_custom_form.setValue("class_date", [date]);
  ...
  return (
    <div className="min-h-screen bg-gray-100 pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <h2 className="text-3xl font-bold text-[#80A8BD] mb-6">
          ...
          <Form {...class_updata_custom_form}>
            <form
              onSubmit={class_updata_custom_form.handleSubmit((values) => {
                startTransition(() => {
                  updateClass(values).then((result) => {
                    if (result?.error) {
                      ...
                      <FormControl>
                        <div>
                          <DatePicker
                            ...
                            className="w-full border border-gray-300 rounded-md p-2 focus:border-[#80A8BD] focus:ring-[#80A8BD] transition-colors duration-300"
                            containerStyle={{
                              width: "100%",
                            }}
                          />
                          <Input
                            ...
                            readOnly
                            className="mt-2 border-gray-300 focus:border-[#80A8BD] focus:ring-[#80A8BD] transition-colors duration-300"
                            disabled={isPending}
                          />
                        </div>
                      </FormControl>
                    ...
                    <FormItem className="flex items-center space-x-2">
                      ...
                      <FormControl>
                        <Switch
                          ...
                          disabled={isPending}
                          className="data-[state=checked]:bg-[#80A8BD]"
                        />
                      </FormControl>
                      <FormMessage className="text-red-500" />
                    </FormItem>
