      ...
      <Form {...admin_update_form}>
        ...
        >
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-[#e7915b] font-medium">用戶 ID</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={SupAdminID}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-[#e7915b] font-medium">用戶名稱</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    disabled={isPending}
                    placeholder="輸入用戶名稱"
                    className="border-gray-300 focus:ring-[#e7915b] focus:border-[#e7915b]"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-[#e7915b] font-medium">暱稱</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    disabled={isPending}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-[#e7915b] font-medium">電郵</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    disabled={isPending}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-[#e7915b] font-medium">電話</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    disabled={isPending}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-[#e7915b] font-medium">分校</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    disabled={isPending}
              ...
              <FormItem className="flex items-center space-x-2">
                <FormControl>
                  <Checkbox
                    ...
                    onCheckedChange={field.onChange}
                    disabled={isPending}
                    className="border-gray-300 text-[#e7915b]"
                  />
                </FormControl>
                <FormLabel className="text-[#e7915b] font-medium">職員</FormLabel>
                <FormMessage />
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex items-center space-x-2">
                ...
                <FormLabel className="text-[#e7915b] font-medium">是否 ADMIN</FormLabel>
                <FormMessage />
              </FormItem>
            )}
          />
