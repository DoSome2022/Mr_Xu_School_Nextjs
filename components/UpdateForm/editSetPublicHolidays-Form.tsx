        ...
        >
          <div className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-xl font-semibold text-[#80A8BD]">
                    修改公眾假期
                  </FormLabel>
                  <FormControl>
                    <DatePicker
                      ...
                      inputClass="w-full border border-gray-300 rounded-md px-3 py-2 text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#80A8BD] transition-colors duration-300 hover:border-[#80A8BD]"
                    />
                  </FormControl>
          ...
          <Button
            type="submit"
            disabled={isPending}
            className="w-full bg-[#80A8BD] text-white text-sm font-medium rounded-md px-4 py-2 hover:bg-cyan-200 hover:text-[#80A8BD] transition-colors duration-300 disabled:opacity-50"
          >
            提交
          </Button>
        </form>
