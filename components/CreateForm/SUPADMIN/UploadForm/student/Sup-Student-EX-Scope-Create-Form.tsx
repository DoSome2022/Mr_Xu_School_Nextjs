...
const Student_EX_Scope_Create_Formbysupadmin = ({ studentId, data }: Student_BookList_Create_FormProps) => {
  ...
  }, [data, studentId, parentId, supadminId, form]);
    ...
    startTransition(() => {
      SupcreateStudentExScope(values).then((data) => {
        if (data?.error) {
          ...
          router.push(`/supadmin/${supadminId}/userLists/parentsLists/${parentId}/studentLists/${studentId}/exscopeLists`);
        }
      });
    });
  };
