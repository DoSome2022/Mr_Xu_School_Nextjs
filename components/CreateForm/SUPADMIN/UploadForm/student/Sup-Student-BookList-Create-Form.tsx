...
const Student_BookList_Create_Formbysupadmin = ({ studentId , data }: Student_BookList_Create_FormProps) =>{
    ...
    const student_booklist_create_form = useForm<z.infer<typeof Supstudent_booklist_Create_Schema >>({
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const student_booklist_create_form_onSubmit = (values : z.infer <typeof Supstudent_booklist_Create_Schema>) =>{
