...
const Student_EX_Page_Create_Formbysupadminbysupadmin = ({studentId , data}:Student_EX_Page_Create_FormProps) =>{
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const student_ex_pager_create_form_onSubmit = ( values : z.infer<typeof Supstudent_ex_paper_Create_Schema> ) =>{
