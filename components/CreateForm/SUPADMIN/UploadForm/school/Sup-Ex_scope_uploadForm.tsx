...
import EX_Scope_Create_Form_bysupadmin from "../../Sup-EX-Scope-Create-Form";
...
const Ex_scope_uploadFormbysupadmin = ({SchoolId} : Ex_scope_uploadFormProps) => {
    ...
    return (
        <>
            ...
            <EX_Scope_Create_Form_bysupadmin SchoolId={SchoolId} data={GetSchoolById} />

        </>
    )
}

export default Ex_scope_uploadFormbysupadmin