...
import { SupChangeClass_Create_Schema } from "@/actions/supadmin/Create-ChangeClass/schema";
import { SupcreateChangeClass } from "@/actions/supadmin/Create-ChangeClass";
...
const ChangeClass_Create_Formbysupadmin = () => {
  ...
  const ChangeClass_create_form = useForm<z.infer<typeof SupChangeClass_Create_Schema>>({
    resolver: zodResolver(SupChangeClass_Create_Schema),
    defaultValues: {
      studentId: "",
  ...
  const ChangeClass_create_form_onSubmit = (
    values: z.infer<typeof SupChangeClass_Create_Schema>
  ) => {
...
export default ChangeClass_Create_Formbysupadmin;