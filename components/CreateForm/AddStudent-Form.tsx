...
//                   }}
//                   disabled={isPending}
//                   className="border-gray-300 focus:ring-[#80A8BD]"
//                 />
//               </FormControl>
...
const Add_Student_Form = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-100 pt-20 flex justify-center items-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg mt-2">正在加載...</p>
        </div>
      </div>
    );
  }
  ...
  console.log("GetStudentData :", GetStudentData, "-- End --");
  console.log("searchResults :", searchResults, "-- End --");
  console.log("displayData :", displayData, "-- End --");

  return (
    <div className="min-h-screen bg-gray-100 pt-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-2xl font-bold text-[#80A8BD] mb-6">添加學生</h1>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            {error && (
              <div className="text-red-500 bg-red-100 p-3 rounded-md">{error}</div>
            ...
            <div className="space-y-4">
              ...
              <FormField
                ...
                render={() => (
                  <FormItem>
                    <FormLabel className="text-gray-700 font-semibold">選擇學生</FormLabel>
                    <div className="grid gap-2 max-h-96 overflow-y-auto p-4 bg-gray-50 rounded-md border border-gray-200">
                      {displayData.length === 0 ? (
                        <p className="text-gray-600">
                          {searchQuery ? "沒有找到匹配的學生" : "沒有可用的學生數據"}
                        </p>
