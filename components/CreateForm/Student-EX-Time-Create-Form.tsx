...
// import { student_ex_timetable_Create_Schema } from "@/actions/Create-Student_Ex_timetable/schema";
...
//         setSuccess("");
//         startTransition(() => {
//             createStudentExTimeTable(values).then((data) => {
//                 setError(data?.error);
...
//     )
// }
// export default Student_EX_Time_Create_Form
...
const Student_EX_Time_Create_Form = ({ studentId, data }: Student_EX_Time_Create_FormProps) => {
    ...
    const form = useForm<z.infer<typeof student_ex_timetable_Create_Schema>>({
        resolver: zodResolver(student_ex_timetable_Create_Schema),
        defaultValues: {
            parentId: parentId,
            name: "",
    ...
    const onSubmit = (values: z.infer<typeof student_ex_timetable_Create_Schema>) => {
        setError("");
        setSuccess("");
        startTransition(() => {
            createStudentExTimeTable(values).then((data) => {
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="flex justify-end">
                        <Button
                            disabled={isPending}
                            type="submit"
                            className="bg-[#e7915b] hover:bg-[#d6824a] text-white font-medium py-2 px-6 rounded-md shadow-sm transition-colors duration-300"
                        >
                            {isPending ? (
