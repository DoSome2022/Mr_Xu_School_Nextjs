                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Select disabled={isPending} defaultValue={field.value} onValueChange={field.onChange}>
                      <SelectTrigger className="border-0 bg-white text-[#80A8BD] focus:ring-2 focus:ring-cyan-200">
                        <SelectValue placeholder="選擇學校" />
                      </SelectTrigger>
                      <SelectContent>
                    ...
                    <Controller
                      ...
                      render={({ field: { onChange, value } }) => (
                        <DatePicker
                          ...
                          placeholder="選擇日期"
                          disabled={isPending}
                          inputClass="w-full p-2 border-0 bg-white text-[#80A8BD] placeholder:text-gray-400 focus:ring-2 focus:ring-cyan-200 rounded"
                        />
                      )}
                    />
                  </FormControl>
