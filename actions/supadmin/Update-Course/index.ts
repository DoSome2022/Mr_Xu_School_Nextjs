...
// actions/supadmin/Update-Course/index.ts
...
const handler = async (data: InputType): Promise<ReturnType> => {
  const { courseId, course_name, course_subject, persons, grade, teacher, course_teacher_data_id, supadminId } = data;
...
export const Supupdate_Course = CreateSafeAction(SupCourse_Update_Schema, handler);